...
public class Telemovel {
    ...
    public ArrayList<String> getApsInstallNome() {
        ...
        //return new ArrayList<String>(apsInstallNome);
    }
    ...
    public boolean existeEspaco(int numeroBytes) {
        int espacoDisp = this.getApsA() + this.getFotosA();

        return espacoDisp - this.getEspacoTotal() < numeroBytes;
    }
