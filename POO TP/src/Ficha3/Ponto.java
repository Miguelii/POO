...
public class Ponto {
    ...
    /**
     * MÃtodo que desloca um ponto somando um delta Ã s coordenadas
     * em x e y.
     *
    ...
    /**
     * MÃtodo que soma as componentes do Ponto passado como parÃ¢metro.
    ...
    /**
     * MÃtodo que move o Ponto para novas coordenadas.
    ...
    /**
     * MÃtodo que determina se o ponto estÃ¡ no quadrante positivo de x e y
    ...
    /**
     * MÃtodo que determina a distÃ¢ncia de um Ponto a outro.
    ...
    /**
     * MÃtodo que determina se o mÃ³dulo das duas coordenadas Ã© o mesmo.
    ...
    /**
     * MÃtodo que devolve a representaÃ§Ã£o em String do Ponto.
    ...
    /**
     * MÃtodo que faz uma cÃ³pia do objecto receptor da mensagem.
